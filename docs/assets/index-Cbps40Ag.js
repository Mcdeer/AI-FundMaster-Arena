...
{c}%`},labelLine:{lineStyle:{color:"#4b5563"}},data:t.length>0?t:[{name:"未选择",value:100,itemStyle:{color:"#1f2937"}}],itemStyle:{borderColor:"#0a0e17",borderWidth:2,color:o=>e[o.dataIndex%e.length]}}]};N.setOption(n,!0)}function se(){A==null||A.dispose(),A=null,O==null||O.dispose(),O=null,N==null||N.dispose(),N=null}function $t(t,e){if(t.length<e)return[];const n=new Array(t.length).fill(null);let o=0;for(let r=0;r<t.length;r++)o+=t[r],r>=e&&(o-=t[r-e]),r>=e-1&&(n[r]=parseFloat((o/e).toFixed(2)));return n}function ae(t,e=14){if(t.length<e+1)return[];const n=new Array(t.length).fill(null),o=[],r=[];for(let i=1;i<t.length;i++){const l=t[i]-t[i-1];o.push(l>0?l:0),r.push(l<0?-l:0)}let s=o.slice(0,e).reduce((i,l)=>i+l,0)/e,a=r.slice(0,e).reduce((i,l)=>i+l,0)/e;for(let i=e;i<o.length;i++){if(a===0)n[i+1]=100;else{const l=s/a;n[i+1]=parseFloat((100-100/(1+l)).toFixed(1))}s=(s*(e-1)+o[i])/e,a=(a*(e-1)+r[i])/e}return n}let tt=[],R=[],Z="a-share",nt="all",Mt=!1,Lt=!1,Et=!1,Rt=!1,It=!1;function Y(){M.holdings=R.map(t=>({code:t.code,name:t.name,sector:t.sector,market:t.market,weight:t.weight}))}function Gt(){var n;R=[],Y(),Z="a-share",nt="all",M.stocksData&&re(M.stocksData),Mt||(document.querySelectorAll(".market-tab").forEach(o=>{o.addEventListener("click",()=>{document.querySelectorAll(".market-tab").forEach(r=>r.classList.remove("active")),o.classList.add("active"),Z=o.dataset.market,document.getElementById("stock-search").value="",U()})}),Mt=!0),It||((n=document.getElementById("btn-random"))==null||n.addEventListener("click",ce),It=!0);const t=document.getElementById("stock-search");if(t&&!Et){let o=null;t.addEventListener("input",()=>{clearTimeout(o),o=setTimeout(()=>{const r=t.value.trim().toLowerCase();r&&(Z="all",document.querySelectorAll(".market-tab").forEach(s=>s.classList.remove("active"))),U(r)},250)}),Et=!0}Lt||(document.querySelectorAll(".period-btn").forEach(o=>{o.addEventListener("click",()=>{document.querySelectorAll(".period-btn").forEach(s=>s.classList.remove("active")),o.classList.add("active");const r=o.dataset.period;r==="custom"?(document.getElementById("custom-period-wrap").classList.remove("hidden"),M.period="custom"):(document.getElementById("custom-period-wrap").classList.add("hidden"),M.period=r)})}),Lt=!0);const e=document.getElementById("custom-months");e&&!Rt&&(e.addEventListener("input",()=>{M.customMonths=parseInt(e.value)||18}),Rt=!0),Ht(),W()}function re(t){tt=t.stocks,ie(t.sectors),U(),Ht()}function ie(t){const e=document.getElementById("sector-filters");if(!e)return;e.innerHTML="";const n=document.createElement("button");n.className="sector-btn active",n.textContent="全部",n.addEventListener("click",()=>{nt="all",document.querySelectorAll(".sector-btn").forEach(o=>o.classList.remove("active")),n.classList.add("active"),U()}),e.appendChild(n),t.forEach(o=>{const r=document.createElement("button");r.className="sector-btn",r.textContent=o,r.addEventListener("click",()=>{nt=o,document.querySelectorAll(".sector-btn").forEach(s=>s.classList.remove("active")),r.classList.add("active"),U()}),e.appendChild(r)})}function U(t){const e=document.getElementById("stock-grid");if(!e)return;let n=tt;if(t){const o=t.toLowerCase();n=tt.filter(r=>r.name.toLowerCase().includes(o)||r.code.toLowerCase().includes(o)).slice(0,50)}else Z==="all"&&(Z="a-share"),n=tt.filter(o=>{const r=o.market===Z,s=nt==="all"||o.sector===nt;return r&&s});n.sort((o,r)=>r.marketCap-o.marketCap),e.innerHTML=n.map(o=>{var i;const r=R.find(l=>l.code===o.code),s=o.latestPrice;return`
  ...
  `).join("");const n=R.reduce((s,a)=>s+a.weight,0);e.textContent=`合计: ${n}%`,e.className=n===100?"text-sm font-mono text-neon-green":"text-sm font-mono text-neon-red";const o=((r=document.getElementById("lock-weights"))==null?void 0:r.checked)||!1;t.querySelectorAll('[data-action="weight"]').forEach(s=>{s.addEventListener("input",a=>{const i=parseInt(s.dataset.index);R[i].weight=parseInt(a.target.value);const l=t.querySelector(`[data-action="weight-input"][data-index="${i}"]`);l&&(l.value=a.target.value),o?(Y(),W(),J(),V()):Dt(i,parseInt(a.target.value))}),s.addEventListener("change",a=>{if(!o)return;const i=parseInt(s.dataset.index);R[i].weight=parseInt(a.target.value),Y(),W(),J(),V()})}),t.querySelectorAll('[data-action="weight-input"]').forEach(s=>{s.addEventListener("change",a=>{const i=parseInt(s.dataset.index);let l=parseInt(a.target.value)||1;l=Math.max(1,Math.min(95,l)),R[i].weight=l;const c=t.querySelector(`[data-action="weight"][data-index="${i}"]`);c&&(c.value=l),o?(Y(),W(),J(),V()):Dt(i,l)})}),t.querySelectorAll('[data-action="remove"]').forEach(s=>{s.addEventListener("click",()=>{const a=parseInt(s.dataset.index);R.splice(a,1),vt(),Y(),U(),W(),J(),V()})})}function Dt(t,e){const n=R.filter((a,i)=>i!==t);if(n.length===0)return;R[t].weight=e;const o=100-e,r=n.reduce((a,i)=>a+i.weight,0);if(r===0){const a=Math.floor(o/n.length);n.forEach(l=>l.weight=a);const i=n.reduce((l,c)=>l+c.weight,0);n[0].weight+=o-i}else{const a=o/r;let i=0;n.forEach((d,u)=>{d.weight=Math.max(1,Math.round(d.weight*a)),i+=d.weight});let l=o-i,c=0;for(;l!==0&&c<20;){c++;for(const d of n)if(l>0?(d.weight++,l--):l<0&&d.weight>1&&(d.weight--,l++),l===0)break}l!==0&&n.length>0&&(n[0].weight=Math.max(1,n[0].weight+l))}const s=R.reduce((a,i)=>a+i.weight,0);s!==100&&R.length>0&&(R[0].weight+=100-s),Y(),W(),J(),V()}function J(){const t={};R.forEach(n=>{t[n.sector]=(t[n.sector]||0)+n.weight});const e=Object.entries(t).map(([n,o])=>({name:n,value:o}));oe(e)}function ce(){var n;R=[];const t=4+Math.floor(Math.random()*4),e=[...tt].sort(()=>Math.random()-.5);for(let o=0;o<Math.min(t,e.length);o++){const r=e[o];R.push({code:r.code,name:r.name,sector:r.sector,market:r.market,weight:0})}vt(),document.getElementById("stock-search").value="",Z="a-share",document.querySelectorAll(".market-tab").forEach(o=>o.classList.remove("active")),(n=document.querySelector('[data-market="a-share"]'))==null||n.classList.add("active"),U(),W(),J(),V(),showToast(`🎲 随机选中 ${R.length} 只股票，看看运气如何？`)}function Nt(){return R.map(t=>({code:t.code,weight:t.weight}))}function de(){return M.period==="custom"?"custom"+(M.customMonths||18):M.period}let St=!1;function ue(t){var i,l;const{results:e,amount:n,leverage:o}=t,r=n||1e5,s=o||1,a=[...e].sort((c,d)=>c.rank-d.rank);me(a,r,s),ee("chart-returns",a,r,s),ge(a,r,s),St||((i=document.getElementById("chart-mode-pct"))==null||i.addEventListener("click",()=>kt("pct")),(l=document.getElementById("chart-mode-value"))==null||l.addEventListener("click",()=>kt("value")),St=!0)}function me(t,e,n){const o=document.getElementById("ranking-table");if(!o)return;const r=["🥇","🥈","🥉"];o.innerHTML=t.map((s,a)=>{const i=s.isUser,l=a<3?r[a]:s.rank,c=s.totalReturn>=0?"text-neon-red":"text-neon-green",d=i?"user-highlight":"",u=s.totalReturn*n,m=parseFloat(Math.max(-100,u).toFixed(1)),p=Math.round(e*m/100),g=(m>=0?"+":"")+Number(p).toLocaleString(),I=parseFloat((s.maxDrawdown*n).toFixed(1));let D="";if(!i&&s.holdingsDetail&&s.holdingsDetail.length>0){const B=s.holdingsDetail.map(k=>`<div class="flex justify-between text-xs py-1">
    ...
    `}).join(""),window.toggleHoldings||(window.toggleHoldings=function(s){const a=document.getElementById(`holdings-${s}`);a&&a.classList.toggle("hidden")})}function ge(t,e,n){const o=document.getElementById("metrics-table");if(!o)return;const r=["基金","累计收益","年化收益","最大回撤","夏普比率","胜率"],s=t.map(a=>{const i=a.totalReturn>=0?"metric-up":"metric-down",l=a.totalReturn*n,c=parseFloat(Math.max(-100,l).toFixed(1)),d="★".repeat(a.fundRating||0)+"☆".repeat(5-(a.fundRating||0)),u=a.isUser?`
      ...
      <table class="metrics-table w-full text-xs">
        <thead>
          <tr class="border-b border-dark-500/30">
            ${r.map(a=>`<th class="px-3 py-2 text-left font-medium whitespace-nowrap cursor-help" title="${he(a)}">${a}</th>`).join("")}
          </tr>
        </thead>
        <tbody>
          ${s}
...
${n.content}`)});function fe(t,e=null){const{styleTag:n,matchPerson:o,matchPersonDesc:r,matchPersonOrg:s,metrics:a,radarData:i,commentary:l}=t,c=document.getElementById("diagnosis-tag");c&&(c.innerHTML=`
    ...
    `),ne("chart-radar",i,"你的基金");const u=document.getElementById("commentary-text");u&&(e!=null&&e.results&&e.results.length>0?Wt(u,e.results,e.errors):e!=null&&e.loading?xe(u):e!=null&&e.errors&&e.errors.length>0?ve(u,l,e.errors):ye(u,l)),we(a)}function pe(t){const e=document.getElementById("commentary-text");e&&(t.results&&t.results.length>0?Wt(e,t.results,t.errors):t.errors&&t.errors.length>0&&e.innerHTML.includes("loading-dots")&&be(e,t.errors))}function Wt(t,e,n){let o=e.map((s,a)=>{const i=s.model==="Primary API"?"🏢 Primary API":"🌐 Google Gemini";let l=s.text.replace(/\*\*(.+?)\*\*/g,'<strong class="text-neon-blue">$1</strong>').replace(/\*(.+?)\*/g,"<em>$1</em>").split(`
...
`).map(c=>c.trim()).filter(Boolean).map(c=>`<p style="margin-bottom:10px;line-height:1.8;">${c.replace(/\n/g,"<br>")}</p>`).join("");return`<div class="llm-result mb-3">
    ...
    </div>`}).join(e.length>1?'<div style="margin:12px 0;border-top:1px dashed rgba(255,255,255,0.1);"></div>':"");const r=e.map(s=>s.model).join(" + ");o+=`<div class="mt-3 text-right text-xs text-gray-500">🤖 点评由 ${r} 生成 · 仅供参考</div>`,n&&n.length>0&&(o+=`<div class="mt-2 text-right text-xs text-gray-600">
  ...
  `}function ve(t,e,n){let o="";if(e){const r=e.split(`
...
`).map(o=>o.trim()).filter(Boolean);t.innerHTML=n.map((o,r)=>'<p style="margin-bottom:'+(r<n.length-1?"12px":"0")+';line-height:1.8;">'+o+"</p>").join(""),t.innerHTML+='<div class="mt-3 text-right text-xs text-gray-500">📋 离线模板点评 · 仅供参考</div>'}function be(t,e){t.innerHTML=`
    <div class="py-2">
  ...
  `}function we(t){const e=document.getElementById("ai-commentary");if(!e)return;let n=document.getElementById("metrics-summary");n&&n.remove(),n=document.createElement("div"),n.id="metrics-summary";const o=(a,i)=>{if(a==null||isNaN(a))return"-";const l=Math.pow(10,i);return Math.round(a*l)/l},r="★".repeat(t.fundRating||0)+"☆".repeat(5-(t.fundRating||0)),s=t.fundRating>=4?"text-gold-400":t.fundRating>=3?"text-neon-blue":"text-gray-400";n.innerHTML=`
...
要求：幽默风趣，用股民梗，先夸后吐槽，对标人物调侃，给建议，适度用emoji。`}async function Ct(t){var r,s;if(!it.apiKey)return H.push({api:"Primary API",error:"未配置 apiKey（请创建 config.js）"}),null;const e=it.baseUrl||"/api",n=new AbortController,o=setTimeout(()=>n.abort(),15e3);try{const a=await fetch(`${e}/chat/completions`,{method:"POST",headers:{"Content-Type":"application/json",Authorization:`Bearer ${it.apiKey}`},body:JSON.stringify({model:it.model,messages:[{role:"user",content:t}],max_tokens:500,temperature:.8}),signal:n.signal});if(!a.ok){const d=await a.text().catch(()=>"");return H.push({api:"Primary API",error:`HTTP ${a.status}${d?": "+d.slice(0,200):""}`}),null}const l=(s=(r=(await a.json()).choices)==null?void 0:r[0])==null?void 0:s.message,c=((l==null?void 0:l.content)||(l==null?void 0:l.reasoning_content)||"").trim();return c||H.push({api:"Primary API",error:"返回内容为空（可能是 reasoning 模型，或无回复）"}),c||null}catch(a){const i=a.name==="AbortError"?"请求超时（15秒）":a.message||"网络错误";return H.push({api:"Primary API",error:i}),console.warn("[LLM] Primary:",a.message),null}finally{clearTimeout(o)}}async function Tt(t){var o,r,s,a,i,l;if(!Pt)return H.push({api:"Google Gemini",error:"未配置 API Key"}),null;const e=new AbortController,n=setTimeout(()=>e.abort(),15e3);try{const c=await fetch(`https://generativelanguage.googleapis.com/v1beta/models/gemini-1.5-flash:generateContent?key=${Pt}`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({contents:[{parts:[{text:"你是资深基金经理，用中文回复。"+t}]}],generationConfig:{maxOutputTokens:500,temperature:.8}}),signal:e.signal});if(!c.ok){const m=await c.text().catch(()=>"");return H.push({api:"Google Gemini",error:`HTTP ${c.status}${m?": "+m.slice(0,200):""}`}),null}const u=(l=(i=(a=(s=(r=(o=(await c.json()).candidates)==null?void 0:o[0])==null?void 0:r.content)==null?void 0:s.parts)==null?void 0:a[0])==null?void 0:i.text)==null?void 0:l.trim();return u||H.push({api:"Google Gemini",error:"返回内容为空"}),u||null}catch(c){const d=c.name==="AbortError"?"请求超时（15秒）":c.message||"网络错误";return H.push({api:"Google Gemini",error:d}),console.warn("[LLM] Gemini:",c.message),null}finally{clearTimeout(n)}}const M={currentScreen:"builder",fundName:"",holdings:[],period:"1y",customMonths:18,backtestResults:null,stocksData:null,userResult:null,investAmount:1e5,leverage:1};let lt=null,pt=null;function Ce(){const t=document.getElementById("particle-canvas");if(!t)return;const e=t.getContext("2d");let n=[];lt&&(cancelAnimationFrame(lt),lt=null),pt&&window.removeEventListener("resize",pt);function o(){t.width=window.innerWidth,t.height=window.innerHeight}o(),pt=o,window.addEventListener("resize",o);class r{constructor(){this.reset()}reset(){this.x=Math.random()*t.width,this.y=Math.random()*t.height,this.size=Math.random()*2+.5,this.speedX=(Math.random()-.5)*.3,this.speedY=(Math.random()-.5)*.3,this.opacity=Math.random()*.5+.1}update(){this.x+=this.speedX,this.y+=this.speedY,(this.x<0||this.x>t.width||this.y<0||this.y>t.height)&&this.reset()}draw(){e.beginPath(),e.arc(this.x,this.y,this.size,0,Math.PI*2),e.fillStyle=`rgba(79, 195, 247, ${this.opacity})`,e.fill()}}for(let a=0;a<80;a++)n.push(new r);function s(){e.clearRect(0,0,t.width,t.height),n.forEach(a=>{a.update(),a.draw()});for(let a=0;a<n.length;a++)for(let i=a+1;i<n.length;i++){const l=n[a].x-n[i].x,c=n[a].y-n[i].y,d=Math.sqrt(l*l+c*c);d<120&&(e.beginPath(),e.moveTo(n[a].x,n[a].y),e.lineTo(n[i].x,n[i].y),e.strokeStyle=`rgba(79, 195, 247, ${.08*(1-d/120)})`,e.lineWidth=.5,e.stroke())}lt=requestAnimationFrame(s)}s()}function yt(t){se(),document.querySelectorAll(".screen").forEach(o=>o.classList.remove("active","hidden")),document.querySelectorAll(".screen").forEach(o=>o.classList.add("hidden"));const e=document.getElementById(`screen-${t}`);e&&(e.classList.remove("hidden"),e.classList.add("active"),e.scrollIntoView({behavior:"smooth",block:"start"})),M.currentScreen=t;const n=document.getElementById("header");n&&(n.style.display=t==="builder"?"":"none")}async function Kt(){try{const e=await fetch("./"+"stocks.json");if(!e.ok)throw new Error(`HTTP ${e.status}`);const n=await e.json();return n.stocks.forEach(o=>{o.latestPrice=o.prices[o.prices.length-1]}),M.stocksData=n,M.stocksData}catch(t){return console.error("Failed to load stocks:",t),null}}async function Te(){var e,n,o,r;const t=document.getElementById("btn-start");t.disabled=!0,t.textContent="⏳ 回测计算中...";try{const s=Nt(),a=de();let i=parseFloat((e=document.getElementById("invest-amount"))==null?void 0:e.value)||1e5;i=Math.max(100,Math.min(1e8,i));const l=parseFloat((n=document.getElementById("leverage"))==null?void 0:n.value)||1;let c=M.fundName||((r=(o=document.getElementById("fund-name"))==null?void 0:o.value)==null?void 0:r.trim());c||(c=je(s,M.stocksData)),M.stocksData||await Kt();const d=Vt(M.stocksData,s,a);d.label=c,d.amount=i,d.leverage=l,M.userResult=d,M.holdings=s,M.investAmount=i,M.leverage=l;const u=Me(M.stocksData,a),m=[d,...u];m.sort((I,D)=>D.totalReturn-I.totalReturn),m.forEach((I,D)=>{I.rank=D+1}),M.backtestResults=m,yt("arena"),ue({fundName:c,period:a,results:m,amount:i,leverage:l});const p={...d,totalReturn:d.totalReturn*l,maxDrawdown:d.maxDrawdown*l},g=Ut(M.stocksData,s,p);g.metrics.leverage=l,De(g)}catch(s){Oe("回测失败："+s.message,"error"),t.disabled=!1,t.textContent="⚡ 开始挑战"}}async function Fe(){yt("diagnosis");const t={...M.userResult,totalReturn:M.userResult.totalReturn*M.leverage,maxDrawdown:M.userResult.maxDrawdown*M.leverage},e=Ut(M.stocksData,M.holdings,t);e.metrics.leverage=M.leverage;const n=Se();let o={results:null,errors:[],loading:n};n||(o=await Bt()),fe(e,o),n&&(o=await Bt(),pe(o))}function Ae(){M.fundName="",M.holdings=[],M.backtestResults=null,M.userResult=null,document.getElementById("fund-name").value="",document.getElementById("btn-start").disabled=!0,yt("builder"),Gt()}function je(t,e){var $;if(!t||t.length===0)return"我的基金";const n={};e&&e.stocks&&e.stocks.forEach(v=>{n[v.code]=v});const o={},r={};let s=!1,a=!1,i=!1,l=!1;t.forEach(v=>{const y=n[v.code];y&&(o[y.market]=(o[y.market]||0)+v.weight,r[y.sector]=(r[y.sector]||0)+v.weight,y.sector==="科技"&&(s=!0),y.sector==="金融"&&(a=!0),y.sector==="消费"&&(i=!0),y.sector==="医药"&&(l=!0))});const c=Object.entries(o).sort((v,y)=>y[1]-v[1]),d=(($=c[0])==null?void 0:$[0])||"a-share",u=c.length,m={"a-share":["华夏","国泰","南方","易方达","嘉实","博时","广发","富国"],hk:["港股","香港","恒生","中港","沪港深"],us:["纳斯达克","标普","美股","全球","海外"],index:["指数","ETF","被动"]};let p;u>=3?p=["全球","国际","环球","世界","跨市场"]:u===2?p=["沪港深","深港通","AH","中美","跨市场"]:p=m[d]||m["a-share"];let g=[];s&&t.length<=3?g=["创新","科技","成长","新兴","前沿","智能"]:a&&t.length<=3?g=["金融","价值","蓝筹","红利","稳健","精选"]:i&&t.length<=3?g=["消费","品质","生活","品牌","升级"]:l&&t.length<=3?g=["健康","医疗","生命","医药","生物"]:t.length>=8?g=["优选","精选","配置","均衡","多元","全能"]:t.length<=3?g=["聚焦","集中","核心","龙头","精选","优势"]:g=["成长","价值","均衡","轮动","趋势","精选","优选","灵活"];const I=["混合","股票","配置","优选","精选","成长","价值","稳健","进取","灵活"],D=p[Math.floor(Math.random()*p.length)],B=g[Math.floor(Math.random()*g.length)],k=I[Math.floor(Math.random()*I.length)],x=[D+B+k,D+k+B,B+k,D+B],h=x[Math.floor(Math.random()*x.length)],w=["超级","至尊","王者","巅峰","传奇","无敌","神级","霸道"];return w[Math.floor(Math.random()*w.length)]+h+"（您）"}async function ze(){Ce(),await Kt(),Gt();const t=document.getElementById("invest-amount");t&&(t.addEventListener("input",n=>{let o=parseInt(n.target.value)||1e5;o=Math.max(100,Math.min(1e8,o)),n.target.value&&parseInt(n.target.value)!==o&&(n.target.value=o)}),t.addEventListener("blur",n=>{let o=parseInt(n.target.value)||1e5;o=Math.max(100,Math.min(1e8,o)),n.target.value=o})),document.getElementById("btn-start").addEventListener("click",Te),document.getElementById("btn-diagnosis").addEventListener("click",Fe),document.getElementById("btn-restart").addEventListener("click",Ae),document.getElementById("fund-name").addEventListener("input",n=>{M.fundName=n.target.value.trim(),V()});const e=document.getElementById("leverage");e&&e.addEventListener("input",()=>{document.getElementById("leverage-display").textContent=e.value+"x"})}ze();let xt=null;function Oe(t,e="info"){const n=document.getElementById("toast-msg");n&&n.remove(),xt&&clearTimeout(xt);const o=e==="error"?"bg-red-500/90":"bg-green-500/90",r=document.createElement("div");r.id="toast-msg",r.className=`fixed top-4 left-1/2 -translate-x-1/2 ${o} text-white px-6 py-3 rounded-xl shadow-lg z-50 text-sm`,r.textContent=t,document.body.appendChild(r),xt=setTimeout(()=>{r.style.opacity="0",r.style.transition="opacity .3s",setTimeout(()=>r.remove(),300)},3e3)}function V(){const t=document.getElementById("btn-start");t&&(t.disabled=Nt().length<1)}
