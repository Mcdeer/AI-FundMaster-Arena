...
{c}%`},labelLine:{lineStyle:{color:"#4b5563"}},data:t.length>0?t:[{name:"未选择",value:100,itemStyle:{color:"#1f2937"}}],itemStyle:{borderColor:"#0a0e17",borderWidth:2,color:o=>e[o.dataIndex%e.length]}}]};N.setOption(n,!0)}function ne(){A==null||A.dispose(),A=null,H==null||H.dispose(),H=null,N==null||N.dispose(),N=null}function kt(t,e){if(t.length<e)return[];const n=new Array(t.length).fill(null);let o=0;for(let r=0;r<t.length;r++)o+=t[r],r>=e&&(o-=t[r-e]),r>=e-1&&(n[r]=parseFloat((o/e).toFixed(2)));return n}function oe(t,e=14){if(t.length<e+1)return[];const n=new Array(t.length).fill(null),o=[],r=[];for(let i=1;i<t.length;i++){const l=t[i]-t[i-1];o.push(l>0?l:0),r.push(l<0?-l:0)}let s=o.slice(0,e).reduce((i,l)=>i+l,0)/e,a=r.slice(0,e).reduce((i,l)=>i+l,0)/e;for(let i=e;i<o.length;i++){if(a===0)n[i+1]=100;else{const l=s/a;n[i+1]=parseFloat((100-100/(1+l)).toFixed(1))}s=(s*(e-1)+o[i])/e,a=(a*(e-1)+r[i])/e}return n}let tt=[],R=[],Z="a-share",nt="all",$t=!1,Mt=!1,Lt=!1,Et=!1,Rt=!1;function K(){M.holdings=R.map(t=>({code:t.code,name:t.name,sector:t.sector,market:t.market,weight:t.weight}))}function Ht(){var n;R=[],K(),Z="a-share",nt="all",M.stocksData&&se(M.stocksData),$t||(document.querySelectorAll(".market-tab").forEach(o=>{o.addEventListener("click",()=>{document.querySelectorAll(".market-tab").forEach(r=>r.classList.remove("active")),o.classList.add("active"),Z=o.dataset.market,document.getElementById("stock-search").value="",G()})}),$t=!0),Rt||((n=document.getElementById("btn-random"))==null||n.addEventListener("click",ie),Rt=!0);const t=document.getElementById("stock-search");if(t&&!Lt){let o=null;t.addEventListener("input",()=>{clearTimeout(o),o=setTimeout(()=>{const r=t.value.trim().toLowerCase();r&&(Z="all",document.querySelectorAll(".market-tab").forEach(s=>s.classList.remove("active"))),G(r)},250)}),Lt=!0}Mt||(document.querySelectorAll(".period-btn").forEach(o=>{o.addEventListener("click",()=>{document.querySelectorAll(".period-btn").forEach(s=>s.classList.remove("active")),o.classList.add("active");const r=o.dataset.period;r==="custom"?(document.getElementById("custom-period-wrap").classList.remove("hidden"),M.period="custom"):(document.getElementById("custom-period-wrap").classList.add("hidden"),M.period=r)})}),Mt=!0);const e=document.getElementById("custom-months");e&&!Et&&(e.addEventListener("input",()=>{M.customMonths=parseInt(e.value)||18}),Et=!0),zt(),W()}function se(t){tt=t.stocks,ae(t.sectors),G(),zt()}function ae(t){const e=document.getElementById("sector-filters");if(!e)return;e.innerHTML="";const n=document.createElement("button");n.className="sector-btn active",n.textContent="全部",n.addEventListener("click",()=>{nt="all",document.querySelectorAll(".sector-btn").forEach(o=>o.classList.remove("active")),n.classList.add("active"),G()}),e.appendChild(n),t.forEach(o=>{const r=document.createElement("button");r.className="sector-btn",r.textContent=o,r.addEventListener("click",()=>{nt=o,document.querySelectorAll(".sector-btn").forEach(s=>s.classList.remove("active")),r.classList.add("active"),G()}),e.appendChild(r)})}function G(t){const e=document.getElementById("stock-grid");if(!e)return;let n=tt;if(t){const o=t.toLowerCase();n=tt.filter(r=>r.name.toLowerCase().includes(o)||r.code.toLowerCase().includes(o)).slice(0,50)}else Z==="all"&&(Z="a-share"),n=tt.filter(o=>{const r=o.market===Z,s=nt==="all"||o.sector===nt;return r&&s});n.sort((o,r)=>r.marketCap-o.marketCap),e.innerHTML=n.map(o=>{var i;const r=R.find(l=>l.code===o.code),s=o.latestPrice;return`
    ...
    `}).join(""),e.querySelectorAll(".stock-card").forEach(o=>{o.addEventListener("click",r=>{r.target.closest(".stock-detail-btn")||Ot(o.dataset)})}),e.querySelectorAll(".stock-detail-btn").forEach(o=>{o.addEventListener("click",r=>{r.stopPropagation();const s=o.dataset.code;re(s)})})}function re(t){var p,m,I,S,P,k;const e=tt.find(x=>x.code===t);if(!e)return;const n=e.prices.slice(-60),o=Math.min(...n),r=Math.max(...n),s={"a-share":"A股",hk:"港股",us:"美股",index:"指数"},a=n[0],l=((n[n.length-1]-a)/a*100).toFixed(2),c=l>=0?"text-neon-red":"text-neon-green",d=l>=0?"+":"",u=l>=0?"#ff5252":"#69f0ae";for(let x=0;x<n.length;x+=10);const h=document.createElement("div");h.className="fixed inset-0 z-50 flex items-center justify-center bg-black/70 backdrop-blur-sm",h.innerHTML=`
  ...
  `,document.body.appendChild(h),(P=h.querySelector(".stock-modal-close"))==null||P.addEventListener("click",()=>h.remove()),(k=h.querySelector(".stock-modal-add"))==null||k.addEventListener("click",function(){const{code:x,name:g,sector:w,market:L}=this.dataset;Ot({code:x,name:g,sector:w,market:L}),h.remove()}),h.addEventListener("click",x=>{x.target===h&&h.remove()}),setTimeout(()=>{const x=document.getElementById(`tech-indicators-${e.code}`);if(!x)return;const g=e.prices.slice(-120),w=kt(g,20),L=kt(g,60),$=oe(g,14);g[g.length-1];const v=w[w.length-1],y=L[L.length-1],b=$[$.length-1],D=v>y?"📈 多头排列":"📉 空头排列",T=b>70?"⚠️ 超买":b<30?"💡 超卖":"➖ 中性";x.innerHTML=`
  ...
  `).join("");const n=R.reduce((s,a)=>s+a.weight,0);e.textContent=`合计: ${n}%`,e.className=n===100?"text-sm font-mono text-neon-green":"text-sm font-mono text-neon-red";const o=((r=document.getElementById("lock-weights"))==null?void 0:r.checked)||!1;t.querySelectorAll('[data-action="weight"]').forEach(s=>{s.addEventListener("input",a=>{const i=parseInt(s.dataset.index);R[i].weight=parseInt(a.target.value);const l=t.querySelector(`[data-action="weight-input"][data-index="${i}"]`);l&&(l.value=a.target.value),o?(K(),W(),Y(),V()):It(i,parseInt(a.target.value))}),s.addEventListener("change",a=>{if(!o)return;const i=parseInt(s.dataset.index);R[i].weight=parseInt(a.target.value),K(),W(),Y(),V()})}),t.querySelectorAll('[data-action="weight-input"]').forEach(s=>{s.addEventListener("change",a=>{const i=parseInt(s.dataset.index);let l=parseInt(a.target.value)||1;l=Math.max(1,Math.min(95,l)),R[i].weight=l;const c=t.querySelector(`[data-action="weight"][data-index="${i}"]`);c&&(c.value=l),o?(K(),W(),Y(),V()):It(i,l)})}),t.querySelectorAll('[data-action="remove"]').forEach(s=>{s.addEventListener("click",()=>{const a=parseInt(s.dataset.index);R.splice(a,1),xt(),K(),G(),W(),Y(),V()})})}function It(t,e){const n=R.filter((a,i)=>i!==t);if(n.length===0)return;R[t].weight=e;const o=100-e,r=n.reduce((a,i)=>a+i.weight,0);if(r===0){const a=Math.floor(o/n.length);n.forEach(l=>l.weight=a);const i=n.reduce((l,c)=>l+c.weight,0);n[0].weight+=o-i}else{const a=o/r;let i=0;n.forEach((d,u)=>{d.weight=Math.max(1,Math.round(d.weight*a)),i+=d.weight});let l=o-i,c=0;for(;l!==0&&c<20;){c++;for(const d of n)if(l>0?(d.weight++,l--):l<0&&d.weight>1&&(d.weight--,l++),l===0)break}l!==0&&n.length>0&&(n[0].weight=Math.max(1,n[0].weight+l))}const s=R.reduce((a,i)=>a+i.weight,0);s!==100&&R.length>0&&(R[0].weight+=100-s),K(),W(),Y(),V()}function Y(){const t={};R.forEach(n=>{t[n.sector]=(t[n.sector]||0)+n.weight});const e=Object.entries(t).map(([n,o])=>({name:n,value:o}));ee(e)}function ie(){var n;R=[];const t=4+Math.floor(Math.random()*4),e=[...tt].sort(()=>Math.random()-.5);for(let o=0;o<Math.min(t,e.length);o++){const r=e[o];R.push({code:r.code,name:r.name,sector:r.sector,market:r.market,weight:0})}xt(),document.getElementById("stock-search").value="",Z="a-share",document.querySelectorAll(".market-tab").forEach(o=>o.classList.remove("active")),(n=document.querySelector('[data-market="a-share"]'))==null||n.classList.add("active"),G(),W(),Y(),V(),showToast(`🎲 随机选中 ${R.length} 只股票，看看运气如何？`)}function qt(){return R.map(t=>({code:t.code,weight:t.weight}))}function le(){return M.period==="custom"?"custom"+(M.customMonths||18):M.period}let St=!1;function ce(t){var i,l;const{results:e,amount:n,leverage:o}=t,r=n||1e5,s=o||1,a=[...e].sort((c,d)=>c.rank-d.rank);de(a,r,s),Zt("chart-returns",a,r,s),ue(a,r,s),St||((i=document.getElementById("chart-mode-pct"))==null||i.addEventListener("click",()=>wt("pct")),(l=document.getElementById("chart-mode-value"))==null||l.addEventListener("click",()=>wt("value")),St=!0)}function de(t,e,n){const o=document.getElementById("ranking-table");if(!o)return;const r=["🥇","🥈","🥉"];o.innerHTML=t.map((s,a)=>{const i=s.isUser,l=a<3?r[a]:s.rank,c=s.totalReturn>=0?"text-neon-red":"text-neon-green",d=i?"user-highlight":"",u=s.totalReturn*n,h=parseFloat(Math.max(-100,u).toFixed(1)),p=Math.round(e*h/100),m=(h>=0?"+":"")+Number(p).toLocaleString(),I=parseFloat((s.maxDrawdown*n).toFixed(1));let S="";if(!i&&s.holdingsDetail&&s.holdingsDetail.length>0){const P=s.holdingsDetail.map(k=>`<div class="flex justify-between text-xs py-1">
    ...
    `}).join(""),window.toggleHoldings||(window.toggleHoldings=function(s){const a=document.getElementById(`holdings-${s}`);a&&a.classList.toggle("hidden")})}function ue(t,e,n){const o=document.getElementById("metrics-table");if(!o)return;const r=["基金","累计收益","年化收益","最大回撤","夏普比率","胜率"],s=t.map(a=>{const i=a.totalReturn>=0?"metric-up":"metric-down",l=a.totalReturn*n,c=parseFloat(Math.max(-100,l).toFixed(1)),d="★".repeat(a.fundRating||0)+"☆".repeat(5-(a.fundRating||0)),u=a.isUser?`
...
💡 **专属建议**：`);const v=[];return I?(v.push("🚨 立即退出所有杠杆仓位，本金没了就什么都没了。"),v.push("📚 建议先学习《聪明的投资者》等经典书籍。"),v.push("🎮 先用模拟盘练习至少3个月。")):P||k?(v.push("🛑 暂停加仓，不要继续摊低成本。"),v.push("🔍 仔细分析每只股票的买入逻辑。"),S&&v.push("📉 降低杠杆至1x或2x。")):x?v.push("🤔 微调策略，优化选股标准。"):g?v.push("📊 加入债券ETF等低风险资产平滑曲线。"):(w||L)&&v.push("💰 适当减仓，锁定部分利润。"),s[1]>60&&v.push(`🔄 ${s[0]}占比过高，建议减仓分散。`),p===1&&!I&&v.push("🌍 建议配置其他市场分散风险。"),e.maxDrawdown>30&&!I&&v.push("🛡️ 设置止损线（如-15%）并严格执行。"),i.push(...v.map((b,D)=>`${D+1}. ${b}`)),i.push(`
...
`)}function Vt(t,e,n){const o={};t.stocks.forEach(k=>{o[k.code]=k});const r={},s={};let a=0,i=0,l=0,c=0;e.forEach(k=>{const x=o[k.code];if(!x)return;const g=k.weight/100;r[x.sector]=(r[x.sector]||0)+k.weight,s[x.market]=(s[x.market]||0)+k.weight,a+=x.revenueGrowth*g,i+=x.roe*g,l+=x.pe*g,x.marketCap>3e3&&c++});const d=e.length<=5?.7:e.length<=7?.4:.25,h=(r.科技||0)>40?.6+Math.random()*.2:.2+Math.random()*.3,p={totalReturn:n.totalReturn,annualizedReturn:n.annualizedReturn,annualizedVol:n.annualizedVol,maxDrawdown:n.maxDrawdown,sharpeRatio:n.sharpeRatio,sortinoRatio:n.sortinoRatio,informationRatio:n.informationRatio,calmarRatio:n.calmarRatio,profitLossRatio:n.profitLossRatio,winRate:n.winRate,fundRating:n.fundRating,ratingReasons:n.ratingReasons,riskLevel:n.riskLevel,leverage:n.leverage,sectorWeights:r,marketWeights:s,concentration:d,turnover:h,revenueGrowth:parseFloat(a.toFixed(1)),roe:parseFloat(i.toFixed(2)),pe:parseFloat(l.toFixed(2)),bluechipRatio:parseFloat((c/e.length).toFixed(2)),maxSectorWeight:parseFloat(Math.max(...Object.values(r)).toFixed(1)),stockCount:e.length,crossMarket:Object.keys(s).length>=2,marketCount:Object.keys(s).length};let m=null,I=0;for(const k of rt)if(k.condition(p)){const x=k.id==="jiucai"?5:k.id==="global"?3:1;x>I&&(I=x,m=k)}m||(m=rt.find(k=>k.id==="balanced")||rt[rt.length-1]);const S=Le(m,p,e,o),P={dimensions:["年化收益","风险控制","行业集中度","跨市场配置","选股ROE"],values:[et(Math.min(100,Math.max(0,p.annualizedReturn+50)),0),et(Math.min(100,Math.max(0,100-p.annualizedVol)),0),et(Math.min(100,Math.max(0,p.maxSectorWeight)),0),et(Math.min(100,Math.max(0,Object.keys(s).length*30)),0),et(Math.min(100,Math.max(0,p.roe*1.5)),0)]};return{styleTag:`${m.emoji} ${m.name}`,matchPerson:m.matchPerson,matchPersonDesc:m.personDesc,matchPersonOrg:m.personOrg||"",styleId:m.id,metrics:p,radarData:P,commentary:S}}const Dt=window.LLM_CONFIG||{},it=Dt.primary||Dt.eastmoney||{baseUrl:"",apiKey:"",model:""};let J=null,Q=[];const Bt=3e4;function Ee(t){return Q=[],J=De(Ie(t)).then(e=>e?[{model:"AI",text:e}]:null),J}async function Pt(){if(!J)return{results:null,errors:[{api:"System",error:"未发起请求"}],loading:!1};let t=null;const e=new Promise(o=>{setTimeout(()=>{o({stillLoading:!0})},100)}),n=await Promise.race([J,e]);return n&&n.stillLoading?t=await J:t=n,J=null,!t||t.length===0?{results:null,errors:[...Q],loading:!1}:{results:t,errors:[...Q],loading:!1}}function Re(){return J!==null}function Ie(t){const{styleTag:e,matchPerson:n,matchPersonDesc:o,matchPersonOrg:r,metrics:s}=t,a=Object.entries(s.sectorWeights||{}).map(([l,c])=>`${l}${c.toFixed(0)}%`).join("、"),i=Object.entries(s.marketWeights||{}).map(([l,c])=>`${{"a-share":"A股",hk:"港股",us:"美股",index:"指数ETF"}[l]||l}${c.toFixed(0)}%`).join("、");return`你是资深基金经理，点评以下投资组合（中文，150-200字，分段，用Markdown但不用标题）：
