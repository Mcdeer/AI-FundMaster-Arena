...
{c}%`},labelLine:{lineStyle:{color:"#4b5563"}},data:t.length>0?t:[{name:"未选择",value:100,itemStyle:{color:"#1f2937"}}],itemStyle:{borderColor:"#0a0e17",borderWidth:2,color:o=>e[o.dataIndex%e.length]}}]};N.setOption(n,!0)}function ne(){A==null||A.dispose(),A=null,H==null||H.dispose(),H=null,N==null||N.dispose(),N=null}function kt(t,e){if(t.length<e)return[];const n=new Array(t.length).fill(null);let o=0;for(let r=0;r<t.length;r++)o+=t[r],r>=e&&(o-=t[r-e]),r>=e-1&&(n[r]=parseFloat((o/e).toFixed(2)));return n}function oe(t,e=14){if(t.length<e+1)return[];const n=new Array(t.length).fill(null),o=[],r=[];for(let i=1;i<t.length;i++){const l=t[i]-t[i-1];o.push(l>0?l:0),r.push(l<0?-l:0)}let s=o.slice(0,e).reduce((i,l)=>i+l,0)/e,a=r.slice(0,e).reduce((i,l)=>i+l,0)/e;for(let i=e;i<o.length;i++){if(a===0)n[i+1]=100;else{const l=s/a;n[i+1]=parseFloat((100-100/(1+l)).toFixed(1))}s=(s*(e-1)+o[i])/e,a=(a*(e-1)+r[i])/e}return n}let tt=[],R=[],Z="a-share",nt="all",$t=!1,Mt=!1,Lt=!1,Et=!1,Rt=!1;function K(){M.holdings=R.map(t=>({code:t.code,name:t.name,sector:t.sector,market:t.market,weight:t.weight}))}function Ht(){var n;R=[],K(),Z="a-share",nt="all",M.stocksData&&se(M.stocksData),$t||(document.querySelectorAll(".market-tab").forEach(o=>{o.addEventListener("click",()=>{document.querySelectorAll(".market-tab").forEach(r=>r.classList.remove("active")),o.classList.add("active"),Z=o.dataset.market,document.getElementById("stock-search").value="",G()})}),$t=!0),Rt||((n=document.getElementById("btn-random"))==null||n.addEventListener("click",ie),Rt=!0);const t=document.getElementById("stock-search");if(t&&!Lt){let o=null;t.addEventListener("input",()=>{clearTimeout(o),o=setTimeout(()=>{const r=t.value.trim().toLowerCase();r&&(Z="all",document.querySelectorAll(".market-tab").forEach(s=>s.classList.remove("active"))),G(r)},250)}),Lt=!0}Mt||(document.querySelectorAll(".period-btn").forEach(o=>{o.addEventListener("click",()=>{document.querySelectorAll(".period-btn").forEach(s=>s.classList.remove("active")),o.classList.add("active");const r=o.dataset.period;r==="custom"?(document.getElementById("custom-period-wrap").classList.remove("hidden"),M.period="custom"):(document.getElementById("custom-period-wrap").classList.add("hidden"),M.period=r)})}),Mt=!0);const e=document.getElementById("custom-months");e&&!Et&&(e.addEventListener("input",()=>{M.customMonths=parseInt(e.value)||18}),Et=!0),zt(),W()}function se(t){tt=t.stocks,ae(t.sectors),G(),zt()}function ae(t){const e=document.getElementById("sector-filters");if(!e)return;e.innerHTML="";const n=document.createElement("button");n.className="sector-btn active",n.textContent="全部",n.addEventListener("click",()=>{nt="all",document.querySelectorAll(".sector-btn").forEach(o=>o.classList.remove("active")),n.classList.add("active"),G()}),e.appendChild(n),t.forEach(o=>{const r=document.createElement("button");r.className="sector-btn",r.textContent=o,r.addEventListener("click",()=>{nt=o,document.querySelectorAll(".sector-btn").forEach(s=>s.classList.remove("active")),r.classList.add("active"),G()}),e.appendChild(r)})}function G(t){const e=document.getElementById("stock-grid");if(!e)return;let n=tt;if(t){const o=t.toLowerCase();n=tt.filter(r=>r.name.toLowerCase().includes(o)||r.code.toLowerCase().includes(o)).slice(0,50)}else Z==="all"&&(Z="a-share"),n=tt.filter(o=>{const r=o.market===Z,s=nt==="all"||o.sector===nt;return r&&s});n.sort((o,r)=>r.marketCap-o.marketCap),e.innerHTML=n.map(o=>{var i;const r=R.find(l=>l.code===o.code),s=o.latestPrice;return`
    ...
    `}).join(""),e.querySelectorAll(".stock-card").forEach(o=>{o.addEventListener("click",r=>{r.target.closest(".stock-detail-btn")||Ot(o.dataset)})}),e.querySelectorAll(".stock-detail-btn").forEach(o=>{o.addEventListener("click",r=>{r.stopPropagation();const s=o.dataset.code;re(s)})})}function re(t){var p,m,I,S,B,k;const e=tt.find(x=>x.code===t);if(!e)return;const n=e.prices.slice(-60),o=Math.min(...n),r=Math.max(...n),s={"a-share":"A股",hk:"港股",us:"美股",index:"指数"},a=n[0],l=((n[n.length-1]-a)/a*100).toFixed(2),d=l>=0?"text-neon-red":"text-neon-green",c=l>=0?"+":"",u=l>=0?"#ff5252":"#69f0ae";for(let x=0;x<n.length;x+=10);const g=document.createElement("div");g.className="fixed inset-0 z-50 flex items-center justify-center bg-black/70 backdrop-blur-sm",g.innerHTML=`
  ...
  `,document.body.appendChild(g),(B=g.querySelector(".stock-modal-close"))==null||B.addEventListener("click",()=>g.remove()),(k=g.querySelector(".stock-modal-add"))==null||k.addEventListener("click",function(){const{code:x,name:h,sector:w,market:L}=this.dataset;Ot({code:x,name:h,sector:w,market:L}),g.remove()}),g.addEventListener("click",x=>{x.target===g&&g.remove()}),setTimeout(()=>{const x=document.getElementById(`tech-indicators-${e.code}`);if(!x)return;const h=e.prices.slice(-120),w=kt(h,20),L=kt(h,60),$=oe(h,14);h[h.length-1];const v=w[w.length-1],y=L[L.length-1],b=$[$.length-1],D=v>y?"📈 多头排列":"📉 空头排列",T=b>70?"⚠️ 超买":b<30?"💡 超卖":"➖ 中性";x.innerHTML=`
  ...
  `}function me(t){return{基金:"基金名称",累计收益:"回测期内的总收益率",年化收益:"按年计算的收益率",最大回撤:"从高点到低点的最大亏损幅度",夏普比率:"风险调整后收益，>1优秀",胜率:"盈利交易日占比"}[t]||t}window.showMetricDetail||(window.showMetricDetail=function(t){var l;const n={sharpe:{title:"夏普比率 (Sharpe Ratio)",content:`夏普比率 = (年化收益率 - 无风险利率) / 年化波动率
...
• ★☆☆☆☆：<1分，需谨慎`}}[t];if(!n)return;(l=document.querySelector(".metric-modal-overlay"))==null||l.remove();const o=document.createElement("div");o.className="metric-modal-overlay fixed inset-0 z-50 flex items-center justify-center bg-black/70 backdrop-blur-sm",o.innerHTML=`
    ...
    `,document.body.appendChild(o);const r=o.querySelector(".metric-modal-close"),s=o.querySelector("button"),a=()=>o.remove();r==null||r.addEventListener("click",a),s==null||s.addEventListener("click",a),o.addEventListener("click",d=>{d.target===o&&a()});const i=d=>{d.key==="Escape"&&(a(),document.removeEventListener("keydown",i))};document.addEventListener("keydown",i)});function ge(t,e=null){const{styleTag:n,matchPerson:o,matchPersonDesc:r,matchPersonOrg:s,metrics:a,radarData:i,commentary:l}=t,d=document.getElementById("diagnosis-tag");d&&(d.innerHTML=`
...
`).map(o=>o.trim()).filter(Boolean);t.innerHTML=n.map((o,r)=>'<p style="margin-bottom:'+(r<n.length-1?"12px":"0")+';line-height:1.8;">'+o+"</p>").join(""),t.innerHTML+='<div class="mt-3 text-right text-xs text-gray-500">📋 离线模板点评 · 仅供参考</div>'}function ve(t,e){t.innerHTML=`
  ...
  `,e.appendChild(n)}const F=252;function z(t,e){const n=Math.pow(10,e);return Math.round(t*n)/n}const be={"3m":Math.floor(F/4),"6m":Math.floor(F/2),"1y":F,"3y":F*3,"5y":F*5,"10y":F*10};function we(t){if(t.startsWith("custom")){const e=parseInt(t.replace("custom",""))||18;return Math.floor(F*e/12)}return be[t]||F}function Wt(t,e,n){var bt;const o=Math.min(we(n),F*10),r={};t.stocks.forEach(f=>{r[f.code]=f});const s=[],a=100,i=((bt=r[e[0].code])==null?void 0:bt.prices.length)||F*5;for(let f=o;f>0;f--){const P=i-f;let ot=0;for(const st of e){const at=r[st.code];if(!at||P>=at.prices.length)continue;const Kt=at.prices[P],Yt=at.prices[i-o],Xt=st.weight/100;ot+=Xt*(Kt/Yt)}s.push(parseFloat((a*ot).toFixed(4)))}const l=s[s.length-1],d=z((l-a)/a*100,2);let c=0,u=s[0];for(const f of s){f>u&&(u=f);const P=(u-f)/u*100;P>c&&(c=P)}c=z(c,2);const g=o/F,p=z((Math.pow(l/a,1/g)-1)*100,2),m=[];for(let f=1;f<s.length;f++)m.push((s[f]-s[f-1])/s[f-1]);const I=m.reduce((f,P)=>f+P,0)/m.length,S=m.reduce((f,P)=>f+Math.pow(P-I,2),0)/m.length,B=Math.sqrt(S),k=z(B*Math.sqrt(F)*100,2),x=.02,h=k>0?z((p/100-x)/(k/100),2):0,w=m.filter(f=>f<0),L=w.length>0?Math.sqrt(w.reduce((f,P)=>f+Math.pow(P-w.reduce((ot,st)=>ot+st,0)/w.length,2),0)/w.length):0,$=L>0?z((p/100-x)/(L*Math.sqrt(F)),2):0,v=z((p/100-x)/1,2),y=m.map(f=>f-x/F),b=Math.sqrt(y.reduce((f,P)=>f+P*P,0)/y.length)*Math.sqrt(F),D=b>0?z((p/100-x)/b,2):0,T=c>0?z(p/c,2):0,E=m.filter(f=>f>0).length,C=z(E/m.length*100,1),ct=m.filter(f=>f>0).reduce((f,P)=>f+P,0)/m.filter(f=>f>0).length||0,U=Math.abs(m.filter(f=>f<0).reduce((f,P)=>f+P,0)/m.filter(f=>f<0).length)||0,dt=U>0?z(ct/U,2):0;let j=0,O=[];h>=1.5?(j+=2,O.push("夏普比率优秀")):h>=1?(j+=1.5,O.push("夏普比率良好")):h>=.5&&(j+=1,O.push("夏普比率一般")),c<=10?(j+=1.5,O.push("回撤控制优秀")):c<=20?(j+=1,O.push("回撤控制良好")):c<=30&&(j+=.5),p>=20?(j+=1.5,O.push("收益表现优秀")):p>=10?(j+=1,O.push("收益表现良好")):p>=5&&(j+=.5),C>=60&&(j+=.5,O.push("胜率较高")),j=Math.min(5,Math.max(1,Math.round(j)));let ut="中";c<=15&&k<=20?ut="低":(c>=30||k>=40)&&(ut="高");const yt=Math.max(1,Math.floor(s.length/50)),mt=[],gt=[];for(let f=0;f<s.length;f+=yt)mt.push(s[f]),gt.push(f);(s.length-1)%yt!==0&&(mt.push(s[s.length-1]),gt.push(s.length-1));const Ut=new Date,ht=new Date(Ut);ht.setDate(ht.getDate()-o);const _t=gt.map(f=>{const P=new Date(ht);return P.setDate(P.getDate()+f),P.getMonth()+1+"/"+P.getDate()});return{name:"user",label:"你的基金",isUser:!0,totalReturn:d,annualizedReturn:p,annualizedVol:k,maxDrawdown:c,sharpeRatio:h,sortinoRatio:$,treynorRatio:v,informationRatio:D,calmarRatio:T,profitLossRatio:dt,winRate:C,fundRating:j,ratingReasons:O,riskLevel:ut,initialValue:a,finalValue:l,chartData:mt,dateLabels:_t,days:o,holdings:e.map(f=>{const P=r[f.code];return{code:f.code,name:(P==null?void 0:P.name)||f.code,weight:f.weight}})}}function ke(t,e){const n=[];return n.push(...$e(t,e)),n.push(...Me(t,e)),n}function q(t,e){const n=Math.pow(10,e);return Math.round(t*n)/n}function $e(t,e){const n=t.stocks,o=n.filter(d=>d.market==="a-share").sort((d,c)=>c.marketCap-d.marketCap).slice(0,20),r=o.map(d=>({code:d.code,weight:q(100/o.length,1)})),s=n.filter(d=>d.market==="a-share"&&(d.sector==="科技"||d.sector==="医药"||d.sector==="新能源")).filter(d=>d.marketCap<5e3).slice(0,15),a=s.map(d=>({code:d.code,weight:q(100/s.length,1)})),i=n.filter(d=>d.market==="us"&&d.sector==="科技").sort((d,c)=>c.marketCap-d.marketCap).slice(0,10),l=i.map(d=>({code:d.code,weight:q(100/i.length,1)}));return[X("benchmark-csi300","沪深300","A股大盘蓝筹基准","🇨🇳",r,t,e),X("benchmark-gem","创业板指","A股成长创新基准","🇨🇳",a,t,e),X("benchmark-nasdaq","纳斯达克100","美股科技龙头基准","🇺🇸",l,t,e)]}function Me(t,e){const n=t.stocks,o=n.filter(u=>u.pe>0&&u.pe<25&&u.dividendYield>2).filter(u=>u.sector==="消费"||u.sector==="金融").sort((u,g)=>g.dividendYield-u.dividendYield).slice(0,8),r=o.map(u=>({code:u.code,weight:q(100/o.length,1)})),s=n.filter(u=>u.revenueGrowth>10).filter(u=>u.sector==="科技"||u.sector==="医药"||u.sector==="新能源").sort((u,g)=>g.revenueGrowth-u.revenueGrowth).slice(0,8),a=s.map(u=>({code:u.code,weight:q(100/s.length,1)})),i=n.map(u=>{const g=u.prices,p=g[g.length-1],m=g[Math.max(0,g.length-63)];return{...u,momentum:q((p-m)/m*100,2)}}).sort((u,g)=>g.momentum-u.momentum).slice(0,8),l=i.map(u=>({code:u.code,weight:q(100/i.length,1)})),d=n.filter(u=>u.roe>5).map(u=>{const g=u.prices,p=g[g.length-1],m=g[Math.max(0,g.length-63)];return{...u,change:q((p-m)/m*100,2)}}).sort((u,g)=>u.change-g.change).slice(0,8),c=d.map(u=>({code:u.code,weight:q(100/d.length,1)}));return[X("ai-value","🐻 价值大师","深度价值投资","🐻",r,t,e),X("ai-growth","🐂 成长猎手","激进成长投资","🐂",a,t,e),X("ai-momentum","🐎 趋势追踪","动量交易策略","🐎",l,t,e),X("ai-reverse","🦉 逆向投资","超跌反转策略","🦉",c,t,e)]}function X(t,e,n,o,r,s,a){const i=Wt(s,r,a);return i.name=t,i.label=e,i.description=n,i.icon=o,i.isUser=!1,i.isBenchmark=t.startsWith("benchmark-"),i.holdingsDetail=r.map(l=>{const d=s.stocks.find(c=>c.code===l.code);return{code:l.code,name:(d==null?void 0:d.name)||l.code,weight:l.weight,sector:(d==null?void 0:d.sector)||"未知",market:(d==null?void 0:d.market)||"未知"}}),i}const rt=[{id:"jiucai",emoji:"🥬",name:"韭菜本菜",matchPerson:"每一个在市场里交过学费的人",personDesc:"初代股民集体回忆",personOrg:"",condition:t=>t.totalReturn<0&&t.concentration>.5},{id:"foxi",emoji:"🧘",name:"佛系躺平派",matchPerson:"但斌",personDesc:"「时间的玫瑰」——买了就当忘了",personOrg:"东方港湾董事长",condition:t=>t.turnover<.3&&t.bluechipRatio>.6},{id:"jiuxiang",emoji:"🍶",name:"酱香科技研究员",matchPerson:"张坤",personDesc:"易方达蓝筹精选掌舵人",personOrg:"易方达基金",condition:t=>(t.sectorWeights.消费||0)>30},{id:"yaoyao",emoji:"💊",name:"医药葛兰分兰",matchPerson:"葛兰",personDesc:"中欧医疗健康，医药赛道信仰者",personOrg:"中欧基金",condition:t=>(t.sectorWeights.医药||0)>40},{id:"ark",emoji:"🚀",name:"ARK中国分K",matchPerson:"Cathie Wood",personDesc:"ARK Invest创始人",personOrg:"ARK Invest",condition:t=>(t.sectorWeights.科技||0)>50&&t.turnover>.5},{id:"buffett",emoji:"👴",name:"巴菲特传人",matchPerson:"Warren Buffett",personDesc:"价值投资灯塔",personOrg:"伯克希尔·哈撒韦",condition:t=>(t.sectorWeights.消费||0)+(t.sectorWeights.金融||0)>50&&t.turnover<.3&&t.roe>15},{id:"diamond",emoji:"🦍",name:"钻石手",matchPerson:"WSB散户大军",personDesc:"「Diamond Hands」——回撤50%也绝不割肉",personOrg:"Reddit r/wallstreetbets",condition:t=>t.maxDrawdown>25&&t.turnover<.3},{id:"wolf",emoji:"🐺",name:"华尔街之狼",matchPerson:"各路游资大佬",personDesc:"高频交易，主打一个刺激",personOrg:"龙虎榜常客",condition:t=>t.turnover>.8},{id:"national",emoji:"🏛️",name:"国家队在逃成员",matchPerson:"社保基金/汇金",personDesc:"银行+央企+蓝筹，稳如泰山",personOrg:"全国社保基金理事会",condition:t=>(t.sectorWeights.金融||0)>40&&t.annualizedVol<20&&t.roe>10},{id:"global",emoji:"🌍",name:"全球宏观玩家",matchPerson:"Ray Dalio",personDesc:"桥水基金创始人",personOrg:"桥水基金",condition:t=>t.crossMarket&&t.marketCount>=3},{id:"growth",emoji:"🌱",name:"成长股猎人",matchPerson:"朱少醒",personDesc:"富国天惠，15年20倍的公募传奇",personOrg:"富国基金",condition:t=>(t.sectorWeights.科技||0)>30&&t.revenueGrowth>20},{id:"balanced",emoji:"⚖️",name:"均衡配置达人",matchPerson:"谢治宇",personDesc:"兴全合润，不偏科的均衡派代表",personOrg:"兴证全球基金",condition:t=>t.maxSectorWeight<35&&t.stockCount>=6}];function et(t,e){if(t==null||isNaN(t))return t;const n=Math.pow(10,e);return Math.round(t*n)/n}function Le(t,e,n,o){var y;const s=Object.entries(e.sectorWeights||{}).sort((b,D)=>D[1]-b[1])[0]||["未知",0];Object.entries(e.marketWeights||{}).sort((b,D)=>D[1]-b[1]);const a={"a-share":"A股",hk:"港股",us:"美股",index:"指数ETF"},i=[],l={},d={};n.forEach(b=>{const D=o[b.code];D&&(l[D.market]=(l[D.market]||0)+b.weight,d[D.sector]=(d[D.sector]||0)+b.weight)});const c=Object.entries(l).sort((b,D)=>D[1]-b[1]),u=Object.entries(d).sort((b,D)=>D[1]-b[1]),g=(y=c[0])==null?void 0:y[0],p=c.length,m=e.leverage||1,I=e.maxDrawdown>=100||e.totalReturn<=-100,S=m>3,B=e.totalReturn<-50,k=e.totalReturn<-20&&e.totalReturn>=-50,x=e.totalReturn<0&&e.totalReturn>=-20,h=e.totalReturn>=0&&e.totalReturn<10,w=e.totalReturn>=10&&e.totalReturn<50,L=e.totalReturn>=50;let $="";if(I?S?$=`💥 **爆仓警告！** 你使用了${m}x杠杆，最终回撤${e.maxDrawdown.toFixed(1)}%，本金几乎归零。这不是投资，这是赌博！高杠杆+重仓=自杀式操作。`:$=`💥 **巨额亏损！** 最大回撤${e.maxDrawdown.toFixed(1)}%，几乎亏光所有本金。你的选股或择时出现了严重问题。`:B?S?$=`📉 **高杠杆惨案！** ${m}x杠杆放大了亏损，最终收益${e.totalReturn.toFixed(1)}%。杠杆是双刃剑，这次你被割伤了。`:$=`📉 **深度套牢！** 亏损${Math.abs(e.totalReturn).toFixed(1)}%，持仓体验极差。建议重新审视每只股票的基本面。`:k?$=`😰 **投资失利！** 亏损${Math.abs(e.totalReturn).toFixed(1)}%，虽然没到爆仓程度，但也足够肉疼。复盘一下原因？`:x?$=`🤔 **白忙一场！** 亏了${Math.abs(e.totalReturn).toFixed(1)}%，承担了风险却没得到回报。`:h?$=`🙂 **小赚一笔！** 盈利${e.totalReturn.toFixed(1)}%，虽然不多但好歹是正收益。`:w?$=`😊 **稳健盈利！** 收益${e.totalReturn.toFixed(1)}%，回撤${e.maxDrawdown.toFixed(1)}%，这是真正的投资能力！`:L&&(S?$=`🚀 **杠杆暴利！** ${m}x杠杆+${e.totalReturn.toFixed(1)}%收益=暴富神话！但别飘，见好就收。`:$=`🌟 **投资大师！** 收益${e.totalReturn.toFixed(1)}%，这是巴菲特级别的表现！`),i.push($),i.push(`
📊 **持仓诊断**：`),u.length>0){const b=u[0],D=b[1]>60?`重仓${b[0]}(${b[1].toFixed(0)}%)，集中度极高，风险集中。`:b[1]>40?`${b[0]}(${b[1].toFixed(0)}%)占比偏高。`:"行业分布较均衡。";i.push(`• ${D}`)}p===1?i.push(`• 全仓${a[g]||g}，单一市场风险集中。`):i.push(`• 跨${p}个市场配置，分散了风险。`),e.stockCount<=2?i.push(`• 仅${e.stockCount}只标的，集中度极高，押注式投资风险极大。`):e.stockCount>=8?i.push(`• ${e.stockCount}只标的，可能过于分散。`):i.push(`• ${e.stockCount}只标的，集中度适中。`),m>1&&(i.push(`
⚠️ **杠杆分析**（${m}x杠杆）：`),I?i.push(`• **爆仓元凶！** ${m}x杠杆导致回撤放大。没有杠杆最多亏${(100/m).toFixed(0)}%，有了杠杆亏了100%+。`):B?i.push(`• **杠杆放大亏损！** ${m}x杠杆让你的亏损速度加快了${m}倍。`):i.push(`• 使用了${m}x杠杆，放大了收益和风险。`)),i.push(`
...
`)}function Vt(t,e,n){const o={};t.stocks.forEach(k=>{o[k.code]=k});const r={},s={};let a=0,i=0,l=0,d=0;e.forEach(k=>{const x=o[k.code];if(!x)return;const h=k.weight/100;r[x.sector]=(r[x.sector]||0)+k.weight,s[x.market]=(s[x.market]||0)+k.weight,a+=x.revenueGrowth*h,i+=x.roe*h,l+=x.pe*h,x.marketCap>3e3&&d++});const c=e.length<=5?.7:e.length<=7?.4:.25,g=(r.科技||0)>40?.6+Math.random()*.2:.2+Math.random()*.3,p={totalReturn:n.totalReturn,annualizedReturn:n.annualizedReturn,annualizedVol:n.annualizedVol,maxDrawdown:n.maxDrawdown,sharpeRatio:n.sharpeRatio,sortinoRatio:n.sortinoRatio,informationRatio:n.informationRatio,calmarRatio:n.calmarRatio,profitLossRatio:n.profitLossRatio,winRate:n.winRate,fundRating:n.fundRating,ratingReasons:n.ratingReasons,riskLevel:n.riskLevel,leverage:n.leverage,sectorWeights:r,marketWeights:s,concentration:c,turnover:g,revenueGrowth:parseFloat(a.toFixed(1)),roe:parseFloat(i.toFixed(2)),pe:parseFloat(l.toFixed(2)),bluechipRatio:parseFloat((d/e.length).toFixed(2)),maxSectorWeight:parseFloat(Math.max(...Object.values(r)).toFixed(1)),stockCount:e.length,crossMarket:Object.keys(s).length>=2,marketCount:Object.keys(s).length};let m=null,I=0;for(const k of rt)if(k.condition(p)){const x=k.id==="jiucai"?5:k.id==="global"?3:1;x>I&&(I=x,m=k)}m||(m=rt.find(k=>k.id==="balanced")||rt[rt.length-1]);const S=Le(m,p,e,o),B={dimensions:["年化收益","风险控制","行业集中度","跨市场配置","选股ROE"],values:[et(Math.min(100,Math.max(0,p.annualizedReturn+50)),0),et(Math.min(100,Math.max(0,100-p.annualizedVol)),0),et(Math.min(100,Math.max(0,p.maxSectorWeight)),0),et(Math.min(100,Math.max(0,Object.keys(s).length*30)),0),et(Math.min(100,Math.max(0,p.roe*1.5)),0)]};return{styleTag:`${m.emoji} ${m.name}`,matchPerson:m.matchPerson,matchPersonDesc:m.personDesc,matchPersonOrg:m.personOrg||"",styleId:m.id,metrics:p,radarData:B,commentary:S}}const Dt=window.LLM_CONFIG||{},it=Dt.primary||Dt.eastmoney||{baseUrl:"",apiKey:"",model:""};let J=null,Q=[];const Pt=3e4;function Ee(t){return Q=[],J=De(Ie(t)).then(e=>e?[{model:"AI",text:e}]:null),J}async function Bt(){if(!J)return{results:null,errors:[{api:"System",error:"未发起请求"}],loading:!1};let t=null;const e=new Promise(o=>{setTimeout(()=>{o({stillLoading:!0})},100)}),n=await Promise.race([J,e]);return n&&n.stillLoading?t=await J:t=n,J=null,!t||t.length===0?{results:null,errors:[...Q],loading:!1}:{results:t,errors:[...Q],loading:!1}}function Re(){return J!==null}function Ie(t){const{styleTag:e,matchPerson:n,matchPersonDesc:o,matchPersonOrg:r,metrics:s}=t,a=Object.entries(s.sectorWeights||{}).map(([c,u])=>`${c}${u.toFixed(0)}%`).join("、"),i=Object.entries(s.marketWeights||{}).map(([c,u])=>`${{"a-share":"A股",hk:"港股",us:"美股",index:"指数ETF"}[c]||c}${u.toFixed(0)}%`).join("、"),d=(s.annualizedReturn||0)>=0;return`你是东方财富的资深基金经理，点评以下投资组合（中文，200-250字，分段，用Markdown但不用标题）：
...
${d?'- 用户赚了钱，邀请他去东方财富股吧分享经验，例如"赚了别藏着，去东方财富股吧晒晒操作，让韭菜们学学"或类似表达':'- 用户亏了钱，推荐东方财富APP帮他扭亏，例如"亏了别慌，下载东方财富APP，权威专业及时，帮你找回场子"或类似表达'}
5. 引导要巧妙自然，像朋友聊天一样带出来，不要像广告`}function Se(t){if(!t)return"";const e=[/最终回答[：:]\s*/,/最终点评[：:]\s*/,/以下是点评[：:]\s*/,/点评如下[：:]\s*/,/回复[：:]\s*\n/];for(const r of e){const s=t.match(r);if(s){const a=t.slice(s.index+s[0].length).trim();if(a.length>50)return a}}const n=t.split(/\n\n+/).filter(r=>r.trim());if(n.length>=3)for(let r=n.length-1;r>=0;r--){const s=n[r].trim();if(!/^(我们|首先|需要|用户|任务|好的|让我|我来|根据|这个|以上|下面|那么|所以|因此|总之|现在)/.test(s)&&s.length>30)return n.slice(r).join(`

`)}const o=t.replace(/^.*?我们需要.*?\n/s,"").trim();return o.length>50?o:t.trim()}async function De(t){var r,s;if(!it.apiKey)return Q.push({api:"API",error:"未配置 apiKey（请创建 config.js 并填入 Key）"}),null;const e=it.baseUrl||"/api",n=new AbortController,o=setTimeout(()=>n.abort(),Pt);try{const a=await fetch(`${e}/chat/completions`,{method:"POST",headers:{"Content-Type":"application/json",Authorization:`Bearer ${it.apiKey}`},body:JSON.stringify({model:it.model,messages:[{role:"system",content:"你是东方财富的资深基金经理。直接输出点评正文，禁止输出思考过程。少用引号，适度emoji，结尾自然引导到东方财富产品。"},{role:"user",content:t}],max_tokens:2e3,temperature:.8}),signal:n.signal});if(!a.ok){const c=await a.text().catch(()=>"");return Q.push({api:"API",error:`HTTP ${a.status}${c?": "+c.slice(0,200):""}`}),null}const l=(s=(r=(await a.json()).choices)==null?void 0:r[0])==null?void 0:s.message;let d=((l==null?void 0:l.content)||"").trim();return!d&&(l!=null&&l.reasoning_content)&&(d=Se(l.reasoning_content)),d||Q.push({api:"API",error:"返回内容为空（模型未输出有效回复）"}),d||null}catch(a){const i=a.name==="AbortError"?`请求超时（${Pt/1e3}秒）。请检查：1) 是否在公司内网 2) Vite 代理是否正常 3) API 地址是否正确`:a.message||"网络错误";return Q.push({api:"API",error:i}),console.warn("[LLM]",a.message),null}finally{clearTimeout(o)}}const M={currentScreen:"builder",fundName:"",holdings:[],period:"1y",customMonths:18,backtestResults:null,stocksData:null,userResult:null,investAmount:1e5,leverage:1};let lt=null,ft=null;function Pe(){const t=document.getElementById("particle-canvas");if(!t)return;const e=t.getContext("2d");let n=[];lt&&(cancelAnimationFrame(lt),lt=null),ft&&window.removeEventListener("resize",ft);function o(){t.width=window.innerWidth,t.height=window.innerHeight}o(),ft=o,window.addEventListener("resize",o);class r{constructor(){this.reset()}reset(){this.x=Math.random()*t.width,this.y=Math.random()*t.height,this.size=Math.random()*2+.5,this.speedX=(Math.random()-.5)*.3,this.speedY=(Math.random()-.5)*.3,this.opacity=Math.random()*.5+.1}update(){this.x+=this.speedX,this.y+=this.speedY,(this.x<0||this.x>t.width||this.y<0||this.y>t.height)&&this.reset()}draw(){e.beginPath(),e.arc(this.x,this.y,this.size,0,Math.PI*2),e.fillStyle=`rgba(79, 195, 247, ${this.opacity})`,e.fill()}}for(let a=0;a<80;a++)n.push(new r);function s(){e.clearRect(0,0,t.width,t.height),n.forEach(a=>{a.update(),a.draw()});for(let a=0;a<n.length;a++)for(let i=a+1;i<n.length;i++){const l=n[a].x-n[i].x,d=n[a].y-n[i].y,c=Math.sqrt(l*l+d*d);c<120&&(e.beginPath(),e.moveTo(n[a].x,n[a].y),e.lineTo(n[i].x,n[i].y),e.strokeStyle=`rgba(79, 195, 247, ${.08*(1-c/120)})`,e.lineWidth=.5,e.stroke())}lt=requestAnimationFrame(s)}s()}function vt(t){ne(),document.querySelectorAll(".screen").forEach(o=>o.classList.remove("active","hidden")),document.querySelectorAll(".screen").forEach(o=>o.classList.add("hidden"));const e=document.getElementById(`screen-${t}`);e&&(e.classList.remove("hidden"),e.classList.add("active"),e.scrollIntoView({behavior:"smooth",block:"start"})),M.currentScreen=t;const n=document.getElementById("header");n&&(n.style.display=t==="builder"?"":"none")}async function Gt(){try{const e=await fetch("./"+"stocks.json");if(!e.ok)throw new Error(`HTTP ${e.status}`);const n=await e.json();return n.stocks.forEach(o=>{o.latestPrice=o.prices[o.prices.length-1]}),M.stocksData=n,M.stocksData}catch(t){return console.error("Failed to load stocks:",t),null}}async function Be(){var e,n,o,r;const t=document.getElementById("btn-start");t.disabled=!0,t.textContent="⏳ 回测计算中...";try{const s=qt(),a=le();let i=parseFloat((e=document.getElementById("invest-amount"))==null?void 0:e.value)||1e5;i=Math.max(100,Math.min(1e8,i));const l=parseFloat((n=document.getElementById("leverage"))==null?void 0:n.value)||1;let d=M.fundName||((r=(o=document.getElementById("fund-name"))==null?void 0:o.value)==null?void 0:r.trim());d||(d=Te(s,M.stocksData)),M.stocksData||await Gt();const c=Wt(M.stocksData,s,a);c.label=d,c.amount=i,c.leverage=l,M.userResult=c,M.holdings=s,M.investAmount=i,M.leverage=l;const u=ke(M.stocksData,a),g=[c,...u];g.sort((I,S)=>S.totalReturn-I.totalReturn),g.forEach((I,S)=>{I.rank=S+1}),M.backtestResults=g,vt("arena"),ce({fundName:d,period:a,results:g,amount:i,leverage:l});const p={...c,totalReturn:c.totalReturn*l,maxDrawdown:c.maxDrawdown*l},m=Vt(M.stocksData,s,p);m.metrics.leverage=l,Ee(m)}catch(s){je("回测失败："+s.message,"error"),t.disabled=!1,t.textContent="⚡ 开始挑战"}}async function Ce(){vt("diagnosis");const t={...M.userResult,totalReturn:M.userResult.totalReturn*M.leverage,maxDrawdown:M.userResult.maxDrawdown*M.leverage},e=Vt(M.stocksData,M.holdings,t);e.metrics.leverage=M.leverage;const n=Re();let o={results:null,errors:[],loading:n};n||(o=await Bt()),ge(e,o),n&&(o=await Bt(),he(o))}function Fe(){M.fundName="",M.holdings=[],M.backtestResults=null,M.userResult=null,document.getElementById("fund-name").value="",document.getElementById("btn-start").disabled=!0,vt("builder"),Ht()}function Te(t,e){var $;if(!t||t.length===0)return"我的基金";const n={};e&&e.stocks&&e.stocks.forEach(v=>{n[v.code]=v});const o={},r={};let s=!1,a=!1,i=!1,l=!1;t.forEach(v=>{const y=n[v.code];y&&(o[y.market]=(o[y.market]||0)+v.weight,r[y.sector]=(r[y.sector]||0)+v.weight,y.sector==="科技"&&(s=!0),y.sector==="金融"&&(a=!0),y.sector==="消费"&&(i=!0),y.sector==="医药"&&(l=!0))});const d=Object.entries(o).sort((v,y)=>y[1]-v[1]),c=(($=d[0])==null?void 0:$[0])||"a-share",u=d.length,g={"a-share":["华夏","国泰","南方","易方达","嘉实","博时","广发","富国"],hk:["港股","香港","恒生","中港","沪港深"],us:["纳斯达克","标普","美股","全球","海外"],index:["指数","ETF","被动"]};let p;u>=3?p=["全球","国际","环球","世界","跨市场"]:u===2?p=["沪港深","深港通","AH","中美","跨市场"]:p=g[c]||g["a-share"];let m=[];s&&t.length<=3?m=["创新","科技","成长","新兴","前沿","智能"]:a&&t.length<=3?m=["金融","价值","蓝筹","红利","稳健","精选"]:i&&t.length<=3?m=["消费","品质","生活","品牌","升级"]:l&&t.length<=3?m=["健康","医疗","生命","医药","生物"]:t.length>=8?m=["优选","精选","配置","均衡","多元","全能"]:t.length<=3?m=["聚焦","集中","核心","龙头","精选","优势"]:m=["成长","价值","均衡","轮动","趋势","精选","优选","灵活"];const I=["混合","股票","配置","优选","精选","成长","价值","稳健","进取","灵活"],S=p[Math.floor(Math.random()*p.length)],B=m[Math.floor(Math.random()*m.length)],k=I[Math.floor(Math.random()*I.length)],x=[S+B+k,S+k+B,B+k,S+B],h=x[Math.floor(Math.random()*x.length)],w=["超级","至尊","王者","巅峰","传奇","无敌","神级","霸道"];return w[Math.floor(Math.random()*w.length)]+h+"（您）"}async function Ae(){Pe(),await Gt(),Ht();const t=document.getElementById("invest-amount");t&&(t.addEventListener("input",n=>{let o=parseInt(n.target.value)||1e5;o=Math.max(100,Math.min(1e8,o)),n.target.value&&parseInt(n.target.value)!==o&&(n.target.value=o)}),t.addEventListener("blur",n=>{let o=parseInt(n.target.value)||1e5;o=Math.max(100,Math.min(1e8,o)),n.target.value=o})),document.getElementById("btn-start").addEventListener("click",Be),document.getElementById("btn-diagnosis").addEventListener("click",Ce),document.getElementById("btn-restart").addEventListener("click",Fe),document.getElementById("fund-name").addEventListener("input",n=>{M.fundName=n.target.value.trim(),V()});const e=document.getElementById("leverage");e&&e.addEventListener("input",()=>{document.getElementById("leverage-display").textContent=e.value+"x"})}Ae();let pt=null;function je(t,e="info"){const n=document.getElementById("toast-msg");n&&n.remove(),pt&&clearTimeout(pt);const o=e==="error"?"bg-red-500/90":"bg-green-500/90",r=document.createElement("div");r.id="toast-msg",r.className=`fixed top-4 left-1/2 -translate-x-1/2 ${o} text-white px-6 py-3 rounded-xl shadow-lg z-50 text-sm`,r.textContent=t,document.body.appendChild(r),pt=setTimeout(()=>{r.style.opacity="0",r.style.transition="opacity .3s",setTimeout(()=>r.remove(),300)},3e3)}function V(){const t=document.getElementById("btn-start");t&&(t.disabled=qt().length<1)}
