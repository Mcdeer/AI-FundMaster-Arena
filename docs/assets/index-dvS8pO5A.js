...
{c}%`},labelLine:{lineStyle:{color:"#4b5563"}},data:t.length>0?t:[{name:"未选择",value:100,itemStyle:{color:"#1f2937"}}],itemStyle:{borderColor:"#0a0e17",borderWidth:2,color:o=>e[o.dataIndex%e.length]}}]};N.setOption(n,!0)}function Gt(){T==null||T.dispose(),T=null,O==null||O.dispose(),O=null,N==null||N.dispose(),N=null}let Z=[],R=[],J="a-share",tt="all",vt=!1,yt=!1,bt=!1,wt=!1;function G(){b.holdings=R.map(t=>({code:t.code,name:t.name,sector:t.sector,market:t.market,weight:t.weight}))}function It(){R=[],G(),J="a-share",tt="all",b.stocksData&&Ut(b.stocksData),vt||(document.querySelectorAll(".market-tab").forEach(n=>{n.addEventListener("click",()=>{document.querySelectorAll(".market-tab").forEach(o=>o.classList.remove("active")),n.classList.add("active"),J=n.dataset.market,document.getElementById("stock-search").value="",K()})}),vt=!0);const t=document.getElementById("stock-search");if(t&&!bt){let n=null;t.addEventListener("input",()=>{clearTimeout(n),n=setTimeout(()=>{const o=t.value.trim().toLowerCase();o&&(J="all",document.querySelectorAll(".market-tab").forEach(r=>r.classList.remove("active"))),K(o)},250)}),bt=!0}yt||(document.querySelectorAll(".period-btn").forEach(n=>{n.addEventListener("click",()=>{document.querySelectorAll(".period-btn").forEach(r=>r.classList.remove("active")),n.classList.add("active");const o=n.dataset.period;o==="custom"?(document.getElementById("custom-period-wrap").classList.remove("hidden"),b.period="custom"):(document.getElementById("custom-period-wrap").classList.add("hidden"),b.period=o)})}),yt=!0);const e=document.getElementById("custom-months");e&&!wt&&(e.addEventListener("input",()=>{b.customMonths=parseInt(e.value)||18}),wt=!0),Dt(),U()}function Ut(t){Z=t.stocks,Yt(t.sectors),K(),Dt()}function Yt(t){const e=document.getElementById("sector-filters");if(!e)return;e.innerHTML="";const n=document.createElement("button");n.className="sector-btn active",n.textContent="全部",n.addEventListener("click",()=>{tt="all",document.querySelectorAll(".sector-btn").forEach(o=>o.classList.remove("active")),n.classList.add("active"),K()}),e.appendChild(n),t.forEach(o=>{const r=document.createElement("button");r.className="sector-btn",r.textContent=o,r.addEventListener("click",()=>{tt=o,document.querySelectorAll(".sector-btn").forEach(a=>a.classList.remove("active")),r.classList.add("active"),K()}),e.appendChild(r)})}function K(t){const e=document.getElementById("stock-grid");if(!e)return;let n=Z;if(t){const o=t.toLowerCase();n=Z.filter(r=>r.name.toLowerCase().includes(o)||r.code.toLowerCase().includes(o)).slice(0,50)}else J==="all"&&(J="a-share"),n=Z.filter(o=>{const r=o.market===J,a=tt==="all"||o.sector===tt;return r&&a});n.sort((o,r)=>r.marketCap-o.marketCap),e.innerHTML=n.map(o=>{var i;const r=R.find(c=>c.code===o.code),a=o.latestPrice;return`
  ...
  `).join("");const n=R.reduce((a,s)=>a+s.weight,0);e.textContent=`合计: ${n}%`,e.className=n===100?"text-sm font-mono text-neon-green":"text-sm font-mono text-neon-red";const o=((r=document.getElementById("lock-weights"))==null?void 0:r.checked)||!1;t.querySelectorAll('[data-action="weight"]').forEach(a=>{a.addEventListener("input",s=>{const i=parseInt(a.dataset.index);R[i].weight=parseInt(s.target.value);const c=t.querySelector(`[data-action="weight-input"][data-index="${i}"]`);c&&(c.value=s.target.value),o?(G(),U(),X(),_()):kt(i,parseInt(s.target.value))}),a.addEventListener("change",s=>{if(!o)return;const i=parseInt(a.dataset.index);R[i].weight=parseInt(s.target.value),G(),U(),X(),_()})}),t.querySelectorAll('[data-action="weight-input"]').forEach(a=>{a.addEventListener("change",s=>{const i=parseInt(a.dataset.index);let c=parseInt(s.target.value)||1;c=Math.max(1,Math.min(95,c)),R[i].weight=c;const d=t.querySelector(`[data-action="weight"][data-index="${i}"]`);d&&(d.value=c),o?(G(),U(),X(),_()):kt(i,c)})}),t.querySelectorAll('[data-action="remove"]').forEach(a=>{a.addEventListener("click",()=>{const s=parseInt(a.dataset.index);R.splice(s,1),Bt(),G(),K(),U(),X(),_()})})}function kt(t,e){const n=R.filter((s,i)=>i!==t);if(n.length===0)return;R[t].weight=e;const o=100-e,r=n.reduce((s,i)=>s+i.weight,0);if(r===0){const s=Math.floor(o/n.length);n.forEach(c=>c.weight=s);const i=n.reduce((c,d)=>c+d.weight,0);n[0].weight+=o-i}else{const s=o/r;let i=0;n.forEach((l,u)=>{l.weight=Math.max(1,Math.round(l.weight*s)),i+=l.weight});let c=o-i,d=0;for(;c!==0&&d<20;){d++;for(const l of n)if(c>0?(l.weight++,c--):c<0&&l.weight>1&&(l.weight--,c++),c===0)break}c!==0&&n.length>0&&(n[0].weight=Math.max(1,n[0].weight+c))}const a=R.reduce((s,i)=>s+i.weight,0);a!==100&&R.length>0&&(R[0].weight+=100-a),G(),U(),X(),_()}function X(){const t={};R.forEach(n=>{t[n.sector]=(t[n.sector]||0)+n.weight});const e=Object.entries(t).map(([n,o])=>({name:n,value:o}));Vt(e)}function Ct(){return R.map(t=>({code:t.code,weight:t.weight}))}function Xt(){return b.period==="custom"?"custom"+(b.customMonths||18):b.period}let $t=!1;function Jt(t){var i,c;const{results:e,amount:n,leverage:o}=t,r=n||1e5,a=o||1,s=[...e].sort((d,l)=>d.rank-l.rank);Qt(s,r,a),Nt("chart-returns",s,r,a),Zt(s,r,a),$t||((i=document.getElementById("chart-mode-pct"))==null||i.addEventListener("click",()=>xt("pct")),(c=document.getElementById("chart-mode-value"))==null||c.addEventListener("click",()=>xt("value")),$t=!0)}function Qt(t,e,n){const o=document.getElementById("ranking-table");if(!o)return;const r=["🥇","🥈","🥉"];o.innerHTML=t.map((a,s)=>{const i=a.isUser,c=s<3?r[s]:a.rank,d=a.totalReturn>=0?"text-neon-red":"text-neon-green",l=i?"user-highlight":"",u=a.totalReturn*n,h=parseFloat(Math.max(-100,u).toFixed(1)),p=Math.round(e*h/100),m=(h>=0?"+":"")+Number(p).toLocaleString(),I=parseFloat((a.maxDrawdown*n).toFixed(1));let C="";if(!i&&a.holdingsDetail&&a.holdingsDetail.length>0){const L=a.holdingsDetail.map(v=>`<div class="flex justify-between text-xs py-1">
    ...
    `}).join(""),window.toggleHoldings||(window.toggleHoldings=function(a){const s=document.getElementById(`holdings-${a}`);s&&s.classList.toggle("hidden")})}function Zt(t,e,n){const o=document.getElementById("metrics-table");if(!o)return;const r=["基金","累计收益","年化收益","最大回撤","夏普比率","胜率"],a=t.map(s=>{const i=s.totalReturn>=0?"metric-up":"metric-down",c=s.totalReturn*n,d=parseFloat(Math.max(-100,c).toFixed(1)),l="★".repeat(s.fundRating||0)+"☆".repeat(5-(s.fundRating||0)),u=s.isUser?`
      ...
      <table class="metrics-table w-full text-xs">
        <thead>
          <tr class="border-b border-dark-500/30">
            ${r.map(s=>`<th class="px-3 py-2 text-left font-medium whitespace-nowrap cursor-help" title="${te(s)}">${s}</th>`).join("")}
          </tr>
        </thead>
        <tbody>
          ${a}
  ...
  `}function te(t){return{基金:"基金名称",累计收益:"回测期内的总收益率",年化收益:"按年计算的收益率",最大回撤:"从高点到低点的最大亏损幅度",夏普比率:"风险调整后收益，>1优秀",胜率:"盈利交易日占比"}[t]||t}window.showMetricDetail||(window.showMetricDetail=function(t){const n={sharpe:{title:"夏普比率 (Sharpe Ratio)",content:`夏普比率 = (年化收益率 - 无风险利率) / 年化波动率
...
${n.content}`)});function ee(t){const{styleTag:e,matchPerson:n,matchPersonDesc:o,matchPersonOrg:r,metrics:a,radarData:s,commentary:i}=t,c=document.getElementById("diagnosis-tag");c&&(c.innerHTML=`
...
`).map(h=>h.trim()).filter(Boolean);l.innerHTML=u.map((h,p)=>'<p style="margin-bottom:'+(p<u.length-1?"12px":"0")+';line-height:1.8;">'+h+"</p>").join("")}ne(a)}function ne(t){const e=document.getElementById("ai-commentary");if(!e)return;let n=document.getElementById("metrics-summary");n&&n.remove(),n=document.createElement("div"),n.id="metrics-summary";const o=(s,i)=>{if(s==null||isNaN(s))return"-";const c=Math.pow(10,i);return Math.round(s*c)/c},r="★".repeat(t.fundRating||0)+"☆".repeat(5-(t.fundRating||0)),a=t.fundRating>=4?"text-gold-400":t.fundRating>=3?"text-neon-blue":"text-gray-400";n.innerHTML=`
...
`)}function ce(t,e,n){const o={};t.stocks.forEach(v=>{o[v.code]=v});const r={},a={};let s=0,i=0,c=0,d=0;e.forEach(v=>{const $=o[v.code];if(!$)return;const g=v.weight/100;r[$.sector]=(r[$.sector]||0)+v.weight,a[$.market]=(a[$.market]||0)+v.weight,s+=$.revenueGrowth*g,i+=$.roe*g,c+=$.pe*g,$.marketCap>3e3&&d++});const l=e.length<=5?.7:e.length<=7?.4:.25,h=(r.科技||0)>40?.6+Math.random()*.2:.2+Math.random()*.3,p={totalReturn:n.totalReturn,annualizedReturn:n.annualizedReturn,annualizedVol:n.annualizedVol,maxDrawdown:n.maxDrawdown,sharpeRatio:n.sharpeRatio,sortinoRatio:n.sortinoRatio,informationRatio:n.informationRatio,calmarRatio:n.calmarRatio,profitLossRatio:n.profitLossRatio,winRate:n.winRate,fundRating:n.fundRating,ratingReasons:n.ratingReasons,riskLevel:n.riskLevel,leverage:n.leverage,sectorWeights:r,marketWeights:a,concentration:l,turnover:h,revenueGrowth:parseFloat(s.toFixed(1)),roe:parseFloat(i.toFixed(2)),pe:parseFloat(c.toFixed(2)),bluechipRatio:parseFloat((d/e.length).toFixed(2)),maxSectorWeight:parseFloat(Math.max(...Object.values(r)).toFixed(1)),stockCount:e.length,crossMarket:Object.keys(a).length>=2,marketCount:Object.keys(a).length};let m=null,I=0;for(const v of at)if(v.condition(p)){const $=v.id==="jiucai"?5:v.id==="global"?3:1;$>I&&(I=$,m=v)}m||(m=at.find(v=>v.id==="balanced")||at[at.length-1]);const C=le(m,p,e,o),L={dimensions:["年化收益","风险控制","行业集中度","跨市场配置","选股ROE"],values:[Q(Math.min(100,Math.max(0,p.annualizedReturn+50)),0),Q(Math.min(100,Math.max(0,100-p.annualizedVol)),0),Q(Math.min(100,Math.max(0,p.maxSectorWeight)),0),Q(Math.min(100,Math.max(0,Object.keys(a).length*30)),0),Q(Math.min(100,Math.max(0,p.roe*1.5)),0)]};return{styleTag:`${m.emoji} ${m.name}`,matchPerson:m.matchPerson,matchPersonDesc:m.personDesc,matchPersonOrg:m.personOrg||"",styleId:m.id,metrics:p,radarData:L,commentary:C}}const b={currentScreen:"builder",fundName:"",holdings:[],period:"1y",customMonths:18,backtestResults:null,stocksData:null,userResult:null,investAmount:1e5,leverage:1};let st=null,mt=null;function de(){const t=document.getElementById("particle-canvas");if(!t)return;const e=t.getContext("2d");let n=[];st&&(cancelAnimationFrame(st),st=null),mt&&window.removeEventListener("resize",mt);function o(){t.width=window.innerWidth,t.height=window.innerHeight}o(),mt=o,window.addEventListener("resize",o);class r{constructor(){this.reset()}reset(){this.x=Math.random()*t.width,this.y=Math.random()*t.height,this.size=Math.random()*2+.5,this.speedX=(Math.random()-.5)*.3,this.speedY=(Math.random()-.5)*.3,this.opacity=Math.random()*.5+.1}update(){this.x+=this.speedX,this.y+=this.speedY,(this.x<0||this.x>t.width||this.y<0||this.y>t.height)&&this.reset()}draw(){e.beginPath(),e.arc(this.x,this.y,this.size,0,Math.PI*2),e.fillStyle=`rgba(79, 195, 247, ${this.opacity})`,e.fill()}}for(let s=0;s<80;s++)n.push(new r);function a(){e.clearRect(0,0,t.width,t.height),n.forEach(s=>{s.update(),s.draw()});for(let s=0;s<n.length;s++)for(let i=s+1;i<n.length;i++){const c=n[s].x-n[i].x,d=n[s].y-n[i].y,l=Math.sqrt(c*c+d*d);l<120&&(e.beginPath(),e.moveTo(n[s].x,n[s].y),e.lineTo(n[i].x,n[i].y),e.strokeStyle=`rgba(79, 195, 247, ${.08*(1-l/120)})`,e.lineWidth=.5,e.stroke())}st=requestAnimationFrame(a)}a()}function ht(t){Gt(),document.querySelectorAll(".screen").forEach(o=>o.classList.remove("active","hidden")),document.querySelectorAll(".screen").forEach(o=>o.classList.add("hidden"));const e=document.getElementById(`screen-${t}`);e&&(e.classList.remove("hidden"),e.classList.add("active"),e.scrollIntoView({behavior:"smooth",block:"start"})),b.currentScreen=t;const n=document.getElementById("header");n&&(n.style.display=t==="builder"?"":"none")}async function Pt(){try{const e=await fetch("./"+"stocks.json");if(!e.ok)throw new Error(`HTTP ${e.status}`);const n=await e.json();return n.stocks.forEach(o=>{o.latestPrice=o.prices[o.prices.length-1]}),b.stocksData=n,b.stocksData}catch(t){return console.error("Failed to load stocks:",t),null}}async function ue(){var e,n,o,r;const t=document.getElementById("btn-start");t.disabled=!0,t.textContent="⏳ 回测计算中...";try{const a=Ct(),s=Xt();let i=parseFloat((e=document.getElementById("invest-amount"))==null?void 0:e.value)||1e5;i=Math.max(100,Math.min(1e8,i));const c=parseFloat((n=document.getElementById("leverage"))==null?void 0:n.value)||1;let d=b.fundName||((r=(o=document.getElementById("fund-name"))==null?void 0:o.value)==null?void 0:r.trim());d||(d=he(a,b.stocksData)),b.stocksData||await Pt();const l=Ft(b.stocksData,a,s);l.label=d,l.amount=i,l.leverage=c,b.userResult=l,b.holdings=a,b.investAmount=i,b.leverage=c;const u=se(b.stocksData,s),h=[l,...u];h.sort((p,m)=>m.totalReturn-p.totalReturn),h.forEach((p,m)=>{p.rank=m+1}),b.backtestResults=h,ht("arena"),Jt({fundName:d,period:s,results:h,amount:i,leverage:c})}catch(a){pe("回测失败："+a.message,"error"),t.disabled=!1,t.textContent="⚡ 开始挑战"}}function me(){ht("diagnosis");const t={...b.userResult,totalReturn:b.userResult.totalReturn*b.leverage,maxDrawdown:b.userResult.maxDrawdown*b.leverage},e=ce(b.stocksData,b.holdings,t);e.metrics.leverage=b.leverage,ee(e)}function ge(){b.fundName="",b.holdings=[],b.backtestResults=null,b.userResult=null,document.getElementById("fund-name").value="",document.getElementById("btn-start").disabled=!0,ht("builder"),It()}function he(t,e){var g;if(!t||t.length===0)return"我的基金";const n={};e&&e.stocks&&e.stocks.forEach(x=>{n[x.code]=x});const o={},r={};let a=!1,s=!1,i=!1,c=!1;t.forEach(x=>{const w=n[x.code];w&&(o[w.market]=(o[w.market]||0)+x.weight,r[w.sector]=(r[w.sector]||0)+x.weight,w.sector==="科技"&&(a=!0),w.sector==="金融"&&(s=!0),w.sector==="消费"&&(i=!0),w.sector==="医药"&&(c=!0))});const d=Object.entries(o).sort((x,w)=>w[1]-x[1]),l=((g=d[0])==null?void 0:g[0])||"a-share",u=d.length,h={"a-share":["华夏","国泰","南方","易方达","嘉实","博时","广发","富国"],hk:["港股","香港","恒生","中港","沪港深"],us:["纳斯达克","标普","美股","全球","海外"],index:["指数","ETF","被动"]};let p;u>=3?p=["全球","国际","环球","世界","跨市场"]:u===2?p=["沪港深","深港通","AH","中美","跨市场"]:p=h[l]||h["a-share"];let m=[];a&&t.length<=3?m=["创新","科技","成长","新兴","前沿","智能"]:s&&t.length<=3?m=["金融","价值","蓝筹","红利","稳健","精选"]:i&&t.length<=3?m=["消费","品质","生活","品牌","升级"]:c&&t.length<=3?m=["健康","医疗","生命","医药","生物"]:t.length>=8?m=["优选","精选","配置","均衡","多元","全能"]:t.length<=3?m=["聚焦","集中","核心","龙头","精选","优势"]:m=["成长","价值","均衡","轮动","趋势","精选","优选","灵活"];const I=["混合","股票","配置","优选","精选","成长","价值","稳健","进取","灵活"],C=p[Math.floor(Math.random()*p.length)],L=m[Math.floor(Math.random()*m.length)],v=I[Math.floor(Math.random()*I.length)],$=[C+L+v,C+v+L,L+v,C+L];return $[Math.floor(Math.random()*$.length)]}async function fe(){de(),await Pt(),It();const t=document.getElementById("invest-amount");t&&(t.addEventListener("input",n=>{let o=parseInt(n.target.value)||1e5;o=Math.max(100,Math.min(1e8,o)),n.target.value&&parseInt(n.target.value)!==o&&(n.target.value=o)}),t.addEventListener("blur",n=>{let o=parseInt(n.target.value)||1e5;o=Math.max(100,Math.min(1e8,o)),n.target.value=o})),document.getElementById("btn-start").addEventListener("click",ue),document.getElementById("btn-diagnosis").addEventListener("click",me),document.getElementById("btn-restart").addEventListener("click",ge),document.getElementById("fund-name").addEventListener("input",n=>{b.fundName=n.target.value.trim(),_()});const e=document.getElementById("leverage");e&&e.addEventListener("input",()=>{document.getElementById("leverage-display").textContent=e.value+"x"})}fe();let gt=null;function pe(t,e="info"){const n=document.getElementById("toast-msg");n&&n.remove(),gt&&clearTimeout(gt);const o=e==="error"?"bg-red-500/90":"bg-green-500/90",r=document.createElement("div");r.id="toast-msg",r.className=`fixed top-4 left-1/2 -translate-x-1/2 ${o} text-white px-6 py-3 rounded-xl shadow-lg z-50 text-sm`,r.textContent=t,document.body.appendChild(r),gt=setTimeout(()=>{r.style.opacity="0",r.style.transition="opacity .3s",setTimeout(()=>r.remove(),300)},3e3)}function _(){const t=document.getElementById("btn-start");t&&(t.disabled=Ct().length<1)}
